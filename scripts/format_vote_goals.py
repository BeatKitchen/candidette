...
SECTIONS = [
    ...
    ("25% of expected turnout  =  ~15,618 votes", "table_row"),
    ("30% of expected turnout  =  ~18,741 votes", "table_row"),
    ("35% of expected turnout  =  ~21,865 votes", "table_row"),
    ("40% of expected turnout  =  ~24,988 votes", "table_row"),
    ("50%+ (win general)  =  ~31,236 votes", "table_total"),

    ("Vote Goals for Ron Davis — General Election, Average Turnout (~79,012)", "heading1"),
    ("25% of expected turnout  =  ~19,753 votes", "table_row"),
    ("30% of expected turnout  =  ~23,704 votes", "table_row"),
    ("35% of expected turnout  =  ~27,654 votes", "table_row"),
    ("40% of expected turnout  =  ~31,605 votes", "table_row"),
    ("50%+ (win general)  =  ~39,506 votes", "table_total"),

    ("Vote Goals for Ron Davis — General Election, High Turnout (~91,369, based on 2020)", "heading1"),
    ("25% of expected turnout  =  ~22,842 votes", "table_row"),
    ("30% of expected turnout  =  ~27,411 votes", "table_row"),
    ("35% of expected turnout  =  ~31,979 votes", "table_row"),
    ("40% of expected turnout  =  ~36,548 votes", "table_row"),
    ("50%+ (win general)  =  ~45,685 votes", "table_total"),
